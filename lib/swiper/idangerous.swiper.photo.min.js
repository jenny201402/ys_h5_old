...
Swiper.prototype = {
    ...
    setWrapperTranslate: function(a, b, c) {
        ...
        var num = $(".swiper-wrapper").attr("data-num");
        ...
        if( Math.abs(f.x) >= imgWidth * num ){
            $(".shadeAre").show(0);
            $(".rechargeBox").removeClass("zoomOutUp").addClass('animated zoomInDown');
        }

        $(document).on("click",".close",function(){
            // $(".shadeAre").fadeOut(1000);
            $(".rechargeBox").removeClass("zoomInDown").addClass('animated zoomOutUp');
        });
    },
